...
- Front end: Designed a simple web chat UI (but have yet to host it on an external server); also able to deploy the chatbot on Slack on my personal workspace
